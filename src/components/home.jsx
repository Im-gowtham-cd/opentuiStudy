    ...
    return (
        <box backgroundColor="yellow" height="90%" width="100%" flexDirection="row">
            <box width="100%" height="100%" alignItems="center" flexDirection="row">
                <box width="58%" alignItems="center" height="100%" flexDirection="column" paddingLeft="5%" paddingTop="5%">
                    <box width="100%" justifyContent="center">
                        <ascii-font font="block" text="Im , GoTM...!" color="black" />
                    </box>
                    <box width="100%" paddingTop="2%">
                        <text fg="black" attributes={TextAttributes.DIM}>
                            Full-Stack Developer passionate about building scalable web applications, developer tools, and impactful digital products using Vue, Next.js, Spring Boot, and the MERN stack.
                        </text>
                    </box>
                    <text fg="yellow" bg="black" width="100%" marginTop="3%">
                        <a href="https://drive.google.com/file/d/1GRA7px064CmkX7BCCcIK2VVZQyqTSQ0g/view?usp=sharing">   Resume   </a>
                    </text>
                    <box width="100%" marginTop="5%">
                        <ascii-font font="tiny" text="What GoTM Do ?" color="black" />
                        <box marginTop={1}>
                            <text fg="black" attributes={TextAttributes.BOLD}>Full-Stack Web Development</text>
                ...
                <box width="37%" alignItems="center" height="100%" paddingLeft="3%" paddingRight="3%" paddingTop="5%">
                    <box width="100%" backgroundColor="black" padding="5%">
                    ...
                    <box marginTop="3%">
                        <text fg="black" attributes={TextAttributes.BOLD}>
                            <a href="https://portiis.pages.dev/Im-gowtham-cd">[o] portiis.pages.dev/Im-gowtham-cd</a>
                        </text>
                    </box>
                </box>
            </box>
